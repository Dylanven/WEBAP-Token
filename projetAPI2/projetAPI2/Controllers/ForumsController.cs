...
namespace projetAPI2.Controllers
{
    ...
    public class ForumsController : ControllerBase
    {
        ...
        public ForumsController(PrototypeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Forum>> PostForum(Forum forum)
        {
          if (_context.Forums == null)
          {
              return Problem("Entity set 'PrototypeContext.Forums'  is null.");
          }
        ...
        {
            return (_context.Forums?.Any(e => e.IdForum == id)).GetValueOrDefault();
        }
    }
}
