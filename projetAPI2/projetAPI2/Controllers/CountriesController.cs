...
namespace projetAPI2.Controllers
{
    ...
    public class CountriesController : ControllerBase
    {
        ...
        public CountriesController(PrototypeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Country>> PostCountry(CountryDTO country)
        {
          if (_context.Countries == null)
          {
              return Problem("Entity set 'PrototypeContext.Countries'  is null.");
          }
            var newCountry = new Country
            {
                CouName = country.CouName,
                CouCode = country.CouCode
            };
            _context.Countries.Add(newCountry);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetCountry", new { id = newCountry.IdCountry }, newCountry);
        }
